        ...
        if xbmc.getCondVisibility('Player.Playing'):
            ...
            if self.updateMode('fastforward'):
                ...
                if not isSpeaking:
                    ...
                    elif    xbmc.getCondVisibility('Player.Forwarding4x') and self.updateProgress('4x'): return '4 X'
                    elif    xbmc.getCondVisibility('Player.Forwarding8x') and self.updateProgress('8x'): return '8 X'
                    elif    xbmc.getCondVisibility('Player.Forwarding16x') and self.updateProgress('16x'): return '16 X'
            ...
            if self.updateMode('rewind'):
                ...
                if not isSpeaking:
                    ...
                    elif    xbmc.getCondVisibility('Player.Rewinding4x') and self.updateProgress('4x'): return '4 X'
                    elif    xbmc.getCondVisibility('Player.Rewinding8x') and self.updateProgress('8x'): return '8 X'
                    elif    xbmc.getCondVisibility('Player.Rewinding16x') and self.updateProgress('16x'): return '16 X'
                    elif    xbmc.getCondVisibility('Player.Rewinding32x') and self.updateProgress('32x'): return '32 X'
        return None
